[![Build Status](https://travis-ci.com/devtea2027/ut-iure-est-asperiores.svg?branch=main)](https://travis-ci.com/devtea2027/ut-iure-est-asperiores)
...
[![Maintainability](https://api.codeclimate.com/v1/badges/31071476c2117e90d6fe/maintainability)](https://codeclimate.com/github/devtea2027/ut-iure-est-asperiores/maintainability)
[![Test Coverage](https://api.codeclimate.com/v1/badges/31071476c2117e90d6fe/test_coverage)](https://codeclimate.com/github/devtea2027/ut-iure-est-asperiores/test_coverage)
...
Install it using npm: `npm install @devtea2027/ut-iure-est-asperiores`

If used in a browser environment, you will need to manually install the local you wish to support.

```javascript
var languages = require("@devtea2027/ut-iure-est-asperiores");

// Support german & english languages.
languages.registerLocale(require("@devtea2027/ut-iure-est-asperiores/langs/en.json"));
languages.registerLocale(require("@devtea2027/ut-iure-est-asperiores/langs/de.json"));
```
